...
import '../../modules/permission_console/permission_console_shell.dart';
import '../colors.dart';
import '../icons.dart';
...
enum HomeTab { blast, threads, groups, permissions }
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildBody() {
    switch (_tab) {
      ...
      case HomeTab.permissions:
        return const PermissionConsoleShell();
      case HomeTab.blast:
      default:
